...
export BASE_RUN_NAME=resume_finetune_Llava-Onevision-siglip-qwen2.5-stage-4_lora_trajectory-test2
...
export MODEL_CLASS_NAME="LlavaOnevisionForConditionalGeneration"
