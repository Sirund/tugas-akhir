...
model_dir=$1
bmk_root=/home/vlm/data/benchmarks
image_folder=/home/vlm/data/eval_data/eval_images
...
python eval/benchmark/eval_robo.py \
    --model_dir=$model_dir  \
...
python eval/compute_scores.py $model_dir/eval_robo
